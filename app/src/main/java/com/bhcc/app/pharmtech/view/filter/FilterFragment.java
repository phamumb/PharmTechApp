...
public class FilterFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        updateListButton.setBackground(getResources().getDrawable(R.drawable.corner_radius_enable));
        updateListButton.setTextColor(Color.WHITE);
        ...
        updateListButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (studyTopicCheckedList.isEmpty()) {
                    ...
                    startActivity(MedicineListActivity.newIntent(getActivity()));
                }
            }
        });
